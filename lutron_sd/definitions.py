...
LUTRON_PROC_SERIAL              = "04E88762"                    # set this to serial number of your processor
LUTRON_PROC_MAC                 = "98:03:8a:31:0d:e2"                # set this to MAC address of your processor
LUTRON_PROC_SYSTEM_TYPE         = "athena"                 # set this to the system name {radioRa3, quantum (older athena procs), athena, myroom, homeworksqs}
LUTRON_PROC_ADDRESS             = "192.168.3.201"      # set this to the IP address or mDNS name of your processor
DEVICE_COMMON_NAME              = "Ganakalabs Development"             # set this to the CN of your company
