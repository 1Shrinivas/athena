...
def send_client_setting_update(sock, version=3):
  ...
  "Header": {
    "Url": "/preset/989/switchedlevelassignment/commandprocessor"
  },
  "Body": {
    "Command": {
      "CommandType": "Filter",
      "FilterParameters": {
        "Where": {
          "Binary": {
            ...
            "Left": {
              "Resource": {
                "href": "$1/assignableresource/associatedarea"
              }
            },
            "Right": {
              "Resource": {
...
#   "Header": {
#     "Url": "/switchedlevelassignment/1097"
#   },
#   "Body": {
...
#   "CommuniqueType": "CreateRequest",
#   "Header": {
#     "Url": "/preset/990/switchedlevelassignment/commandprocessor"
#   },
#   "Body": {
#     "Command": {
#       "CommandType": "Filter",
...
#   "Header": {
#     "MessageBodyType": "MultipleButtonStatusEvent",
#     "StatusCode": "200 OK",
#     "Url": "/device/1143/button/status/event"
#   },
#   "Body": {
#     "ButtonStatus": [
#       {
